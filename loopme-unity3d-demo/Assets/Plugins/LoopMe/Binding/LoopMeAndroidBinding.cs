...
public class LoopMeAndroidBinding {
	...
	private static AndroidJavaObject interstitialUnity;
...
//		JNI.CallVoidMethod(LoopMeClass, SetAppKeyPtr, AndroidJNI.NewStringUTF(appKey));	
		...
		interstitialUnity = new AndroidJavaObject("com.loopme.LoopMeInterstitialUnity", activity);

		interstitialUnity.Call("setAppKey", appKey);
...
//		AndroidJNI.CallVoidMethod(LoopMeClass, DestroyPtr, args);
		interstitialUnity.Call("destroy");
		#endif			
	}
